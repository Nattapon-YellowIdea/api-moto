      ...
      contents: [
        {
          ...
          action: {
            type: 'uri',
            label: 'ชำระเงิน',
            uri: `${process.env.LINE_LIFF_100}/register/payment/summary?order_code=${orderCode}`,
            altUri: {
              desktop: `${process.env.LINE_LIFF_100}/register/payment/summary?order_code=${orderCode}`,
            },
          },
          style: 'secondary',
          color: '#FFD100',
